...
const useConformities = () => {
  ...
  type UnwrapArray<T> = T extends Array<infer U> ? U : T;
	...
	const getArticleListConformitied = <T extends keyof DocumentRouteTree>(key: T, getGroup: (val: Exclude<UnwrapArray<DocumentRouteTree[T]>, undefined>) => string = (v) => String(v), defaultGroup: string = '未分类'): ArticleList => {
