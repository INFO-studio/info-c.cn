...
const initChart = () => {
	...
	const content = svgEl.append("g").attr("transform", `translate(${svgConfig.margin.left}, ${svgConfig.margin.top})`);
	...
	const xAxis = d3.axisBottom(dayScale).tickFormat((d: Date | d3.NumberValue) => {
